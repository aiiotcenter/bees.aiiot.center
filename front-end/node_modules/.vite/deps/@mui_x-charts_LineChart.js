...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const isPointInside = React7.useCallback(({
    x: x2,
    y: y2
  }, options) => {
...
var SeriesContext = React9.createContext({
  isInitialized: false,
  data: {}
});
if (true) {
...
var PluginContext = React10.createContext({
  isInitialized: false,
  data: {
    colorProcessors: {},
    seriesFormatters: {},
...
function PluginProvider(props) {
  ...
  return (0, import_jsx_runtime6.jsx)(PluginContext.Provider, {
...
function useYExtremumGetter(seriesType) {
  const {
    isInitialized,
    data
  } = React15.useContext(PluginContext);
  if (!isInitialized) {
    throw new Error(["MUI X: Could not find the plugin context.", "It looks like you rendered your component outside of a ChartsContainer parent component."].join("\n"));
  }
  if (!seriesType) {
...
function SeriesProvider(props) {
  ...
  const formattedSeries = React18.useMemo(() => ({
    isInitialized: true,
  ...
  return (0, import_jsx_runtime7.jsx)(SeriesContext.Provider, {
    value: formattedSeries,
    children
  });
}
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React19.useContext(SeriesContext);
  if (!isInitialized) {
...
function useLineSeries() {
  ...
  return React19.useMemo(() => series.line, [series.line]);
}

// node_modules/@mui/x-charts/context/CartesianProvider/CartesianContext.js
var React20 = __toESM(require_react());
var CartesianContext = React20.createContext({
  isInitialized: false,
  data: {
    xAxis: {},
    yAxis: {},
...
var InteractionContext = React23.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React23.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React23.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var ZAxisContext = React27.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React27.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
  ...
  return (0, import_jsx_runtime11.jsx)(ZAxisContext.Provider, {
    value,
    children
  });
}
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React29.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React30.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React30.createContext(init));
...
var useStringInterpolator = (path2) => {
  ...
  const interpolator = React31.useMemo(() => memoryRef.previousPath ? string_default(memoryRef.previousPath, memoryRef.currentPath) : () => memoryRef.currentPath, [memoryRef.currentPath, memoryRef.previousPath]);
  return interpolator;
};
...
function AppearingMask(props) {
  ...
  return (0, import_jsx_runtime12.jsxs)(React35.Fragment, {
    children: [(0, import_jsx_runtime12.jsx)("clipPath", {
      id: clipId,
      children: transitionAppear((style) => (0, import_jsx_runtime12.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: style.animatedWidth,
        height: drawingArea.top + drawingArea.height + drawingArea.bottom
      }))
    }), (0, import_jsx_runtime12.jsx)("g", {
      clipPath: `url(#${clipId})`,
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime13.jsx)(AppearingMask, {
    skipAnimation: skipAnimation2,
    id: `${ownerState.id}-area-clip`,
    children: transitionChange((style, interpolator) => (0, import_jsx_runtime13.jsx)(AreaElementPath, _extends({}, other, {
      ownerState,
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime14.jsx)(Area, _extends({}, other, areaProps));
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime15.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime15.jsxs)(React38.Fragment, {
...
var AnimationContext = React41.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React42.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime18.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React43.useContext(AnimationContext);
  if (!isInitialized) {
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime19.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime19.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color2,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(AppearingMask, {
    skipAnimation: skipAnimation2,
    id: `${ownerState.id}-line-clip`,
    children: transitionChange((style, interpolator) => (0, import_jsx_runtime20.jsx)(LineElementPath, _extends({}, other, {
      ownerState,
      d: style.value.to(interpolator)
    })))
  });
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(Line, _extends({}, other, lineProps));
}
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime22.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime22.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color2,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React48.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React50.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React50.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React51.useRef(null);
...
var ChartContainer = React52.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  const stateRef = React53.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const rootRef = React53.useRef(null);
  const [width, setWidth] = React53.useState(0);
  const [height, setHeight] = React53.useState(0);
...
function CircleMarkElement(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(animated.circle, _extends({}, other, {
    cx: position.x,
    cy: position.y,
    r: 5,
...
function MarkElement(props) {
  ...
  const classes = useUtilityClasses3(ownerState);
  return (0, import_jsx_runtime27.jsx)(MarkElementPath, _extends({}, other, {
    style: {
  ...
  return (0, import_jsx_runtime28.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime28.jsx)("g", {
          clipPath: `url(#${clipId})`,
          children: xData == null ? void 0 : xData.map((x2, index2) => {
            ...
            return (0, import_jsx_runtime28.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index2,
              shape: "circle",
...
function ChartsText(props) {
  ...
  const wordsByLines = React58.useMemo(() => getWordsByLines({
    style,
  ...
  return (0, import_jsx_runtime29.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime29.jsx)("tspan", {
      x: x2,
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime30.jsxs)(XAxisRoot, {
    transform: `translate(0, ${position === "bottom" ? top2 + height : top2})`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime30.jsx)(Line, _extends({
      x1: left2,
      x2: left2 + width,
      ...
      return (0, import_jsx_runtime30.jsxs)("g", {
        ...
        children: [!disableTicks && showTick && (0, import_jsx_runtime30.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime30.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime30.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime30.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime31.jsxs)(YAxisRoot, {
    transform: `translate(${position === "right" ? left2 + width : left2}, 0)`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime31.jsx)(Line, _extends({
      y1: top2,
      y2: top2 + height,
      className: classes.line
      ...
      return (0, import_jsx_runtime31.jsxs)("g", {
        transform: `translate(0, ${offset2})`,
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime31.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime31.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index2);
    }), label && (0, import_jsx_runtime31.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime31.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime32.jsxs)(React62.Fragment, {
    children: [topId && (0, import_jsx_runtime32.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime32.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime32.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime32.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
var Popper = React64.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime33.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime33.jsx)(PopperTooltip, {
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Popper3 = React65.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime34.jsx)(PopperRoot, {
    as: component,
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React67.useState(null);
  React67.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types23.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types23.default.shape({
    ...
    type: import_prop_types23.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
...
var Typography = React70.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color2,
    ...themeProps
  } = useDefaultProps({
...
true ? Typography.propTypes = {
   ...
   */
  color: import_prop_types24.default.oneOfType([import_prop_types24.default.oneOf(["primary", "secondary", "success", "error", "info", "warning", "textPrimary", "textSecondary", "textDisabled"]), import_prop_types24.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
      ...
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime38.jsx)("thead", {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime38.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime38.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color2 && (0, import_jsx_runtime38.jsx)(ChartsTooltipMark, {
                color: color2,
                className: classes.mark
              })
            }), (0, import_jsx_runtime38.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime38.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types25.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types25.default.shape({
    x: import_prop_types25.default.shape({
      index: import_prop_types25.default.number,
      value: import_prop_types25.default.oneOfType([import_prop_types25.default.instanceOf(Date), import_prop_types25.default.number, import_prop_types25.default.string]).isRequired
    }),
    y: import_prop_types25.default.shape({
      index: import_prop_types25.default.number,
      value: import_prop_types25.default.oneOfType([import_prop_types25.default.instanceOf(Date), import_prop_types25.default.number, import_prop_types25.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types25.default.oneOfType([import_prop_types25.default.instanceOf(Date), import_prop_types25.default.number, import_prop_types25.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime40.jsx)(NoSsr_default, {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime41.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime41.jsx)("rect", {
...
function LegendPerItem(props) {
  ...
  const padding = React77.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types27.default.oneOf(["column", "row"]).isRequired,
  /**
   * @deprecated Use the `useDrawingArea` hook instead.
   */
  drawingArea: import_prop_types27.default.shape({
    bottom: import_prop_types27.default.number.isRequired,
    height: import_prop_types27.default.number.isRequired,
    left: import_prop_types27.default.number.isRequired,
    right: import_prop_types27.default.number.isRequired,
  ...
  seriesToDisplay: import_prop_types27.default.arrayOf(import_prop_types27.default.shape({
    ...
    itemId: import_prop_types27.default.oneOfType([import_prop_types27.default.number, import_prop_types27.default.string]),
    label: import_prop_types27.default.string.isRequired,
    maxValue: import_prop_types27.default.oneOfType([import_prop_types27.default.instanceOf(Date), import_prop_types27.default.number]),
    minValue: import_prop_types27.default.oneOfType([import_prop_types27.default.instanceOf(Date), import_prop_types27.default.number]),
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime44.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime45.jsxs)(React81.Fragment, {
    ...
    }), (0, import_jsx_runtime45.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types29.default.oneOf(["end", "middle", "start"]),
  /**
   * The axis direction containing the color configuration to represent.
   * @default 'z'
   */
  axisDirection: import_prop_types29.default.oneOf(["x", "y", "z"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types29.default.oneOfType([import_prop_types29.default.number, import_prop_types29.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types29.default.oneOfType([import_prop_types29.default.func, import_prop_types29.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types29.default.oneOfType([import_prop_types29.default.func, import_prop_types29.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types29.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime46.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'z'
   */
  axisDirection: import_prop_types30.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
   ...
   * @default false
   */
  hideFirst: import_prop_types30.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types30.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime47.jsxs)(React83.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime47.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime47.jsx)(ChartsAxisHighlightPath, {
...
true ? ChartsClipPath.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  id: import_prop_types32.default.string.isRequired,
  offset: import_prop_types32.default.shape({
  ...
  return (0, import_jsx_runtime50.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ...
      return groupIds.flatMap((seriesId) => {
        ...
        const colorGetter = getColor_default3(series[seriesId], xAxis[xAxisId], yAxis[yAxisId]);
        return (0, import_jsx_runtime50.jsx)(Element2, _extends({
          id: seriesId,
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime51.jsx)(React87.Fragment, {
    children: xTicks.map(({
      formattedValue,
      offset: offset2
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime52.jsx)(React88.Fragment, {
    children: yTicks.map(({
      formattedValue,
      offset: offset2
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime54.jsx)(React90.Fragment, {});
}
true ? ChartsOnAxisClickHandler.propTypes = {
   ...
   */
  onAxisClick: import_prop_types36.default.func
} : void 0;
...
var LineChart = React94.forwardRef(function LineChart2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiLineChart"
  });
  ...
  return (0, import_jsx_runtime58.jsxs)(ResponsiveChartContainer, _extends({
    ...
    children: [props.onAxisClick && (0, import_jsx_runtime58.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime58.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime58.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime58.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime58.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime58.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime58.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime58.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime58.jsx)("g", {
      "data-drawing-container": true,
      children: (0, import_jsx_runtime58.jsx)(MarkPlot, _extends({}, markPlotProps))
    }), (0, import_jsx_runtime58.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime58.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime58.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime58.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
  ...
  xAxis: import_prop_types37.default.arrayOf(import_prop_types37.default.shape({
    ...
    domainLimit: import_prop_types37.default.oneOfType([import_prop_types37.default.oneOf(["nice", "strict"]), import_prop_types37.default.func]),
